...
async function sendEmailNotification(userId: string, subject: string, message: string): Promise<boolean> {
  ...
  const EMAIL_FROM = process.env.EMAIL_FROM || 'Burozen <noreply@burozen.app>'
        ...
        html: `
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            <div style="text-align: center; margin-bottom: 24px;">
              <h1 style="color: #10b981; font-size: 24px; margin: 0;">Burozen</h1>
            </div>
            ...
            <div style="border-top: 1px solid #e5e7eb; padding-top: 16px; margin-top: 24px;">
              <p style="color: #9ca3af; font-size: 12px; text-align: center;">
                Notification automatique de Burozen — 
