/**
 * PDF Generation Utility for Burozen
 *
...
<body>
  ...
  <div class="header">
    <div class="logo-area">
      ...
      <div>
        <div class="logo-text">${escapeHtml(emitter.name) || 'Burozen'}</div>
  ...
  <div class="footer">
    <div class="footer-left">
      G&eacute;n&eacute;r&eacute; par Burozen &middot; ${new Date().toLocaleDateString('fr-FR')}
    </div>
