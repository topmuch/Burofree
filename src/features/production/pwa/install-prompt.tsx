...
const STORAGE_KEY = 'burofree-install-prompt'
const INTERACTION_KEY = 'burofree-interactions'
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="mt-1 text-xs text-zinc-400">
                    {platform === 'ios' ? (
                      'Accédez à Burofree depuis votre écran d\'accueil pour une expérience optimale.'
                    ) : (
