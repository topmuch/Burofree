...
const providerDescriptions: Record<string, string> = {
  ...
  zoom: 'Créez et gérez vos réunions Zoom sans quitter Burofree.',
  google_drive: 'Accédez à vos fichiers Google Drive et partagez-les avec vos clients.',
  github: 'Synchronisez vos dépôts GitHub avec vos projets Burofree.',
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-zinc-400 mt-1">Connectez vos outils préférés à Burofree</p>
        </div>
