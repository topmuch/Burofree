...
export async function GET(req: NextRequest) {
  try {
    ...
    if (format === 'csv') {
      ...
      // Header section
      lines.push(`Rapport Burofree - ${rangeLabel}`)
...
<body>
  ...
  <!-- Footer -->
  <div class="footer">
    <div>Généré par Burofree &middot; ${data.generatedAt.toLocaleDateString('fr-FR')} ${data.generatedAt.toLocaleTimeString('fr-FR')}</div>
