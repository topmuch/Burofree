...
async function sendWelcomeEmail(email: string, name?: string): Promise<void> {
  ...
  try {
    ...
    await resend.emails.send({
      from: 'Burofree <bienvenue@burofree.com>',
      to: email,
      subject: 'Bienvenue sur Burofree ! 🎉',
      html: `
        <!DOCTYPE html>
        <html lang="fr">
        <head>
          ...
          <div style="max-width: 560px; margin: 0 auto; background: #141414; border-radius: 16px; border: 1px solid #262626; overflow: hidden;">
            ...
            <div style="padding: 32px;">
              <p style="font-size: 16px; line-height: 1.6; color: #d4d4d4;">
                Merci de votre inscription ! Burofree est votre assistant intelligent conçu pour les freelances.
              </p>
              <p style="font-size: 16px; line-height: 1.6; color: #d4d4d4;">
              ...
              <div style="text-align: center; margin: 32px 0;">
                <a href="${process.env.NEXTAUTH_URL || 'https://burofree.com'}/app"
              ...
              <p style="font-size: 13px; color: #737373; text-align: center; margin-top: 24px;">
                Vous recevez cet email car vous vous êtes inscrit sur burofree.com.
              </p>
            </div>
          </div>
        </body>
